	...
	<div class="task-detail-comments">
		<div class="task-comments-and-log">
			<div class="task-comments-log-switcher" id="task-switcher">
				...
				</span><span class="task-switcher" id="task-point-switcher" data-id="point">
					<span class="task-switcher-text">
						<span class="task-switcher-text-inner">
							<?='Балл'?>
							<span class="task-switcher-text-counter" id="task-switcher-elapsed-point"></span>
						</span>
					</span>
				</span>
            ...
            <div class="task-switcher-block task-point-block" id="task-point-block">
     ...
     /*           $APPLICATION->IncludeComponent(
                ...
                $APPLICATION->IncludeComponent("bitrun:iblock.element.add","",Array(
                    "SEF_MODE" => "Y",
                    "AJAX_MODE" => "Y",
